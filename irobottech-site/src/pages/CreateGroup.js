...
const state = {
  ...
  cantidadTipo: 0,
  dias: [{ dia: "Lunes", inicio: "00:00", fin: "00:00" }
          ...
          <Col >
            <form onSubmit={this.handleSubmit}>
              ...
              <div className="grey-text">
                ...
                <Select onChange={this.courseSelect} options={state.courses.map(function (json) {
                ...
                <br></br>
                <BootstrapTable data={state.dias} selectRow={selectRowProp} cellEdit={cellEditProp}>
              ...
              <div className="text-center">
                <Button type="submit" color="primary" id="Register">Registrar Grupo</Button>
              </div>
            </form>
          </Col>
        </Row>
