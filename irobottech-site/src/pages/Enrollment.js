...
class Enrollment extends Component {
    ...
    courseSelect(event) {
        ...
        axios.get(`http://localhost:8080/RegisterCourse/groups/${this.state.COURSE_NAME}`)
            .then(response => {
    ...
    componentDidMount() {
        ...
        axios.get('http://localhost:8080/RegisterCourse')
            .then(response => {
                            ...
                            <CardBody>
                                ...
                                <form  onSubmit={this.matricular}  id="Hola" noValidate>
                                    <div className="grey-text">
                                        ...
                                        <Select onChange={this.courseSelect} options={this.state.courses.map(function (json) {
                                        ...
                                        <Select onChange={this.groupSelect} options={this.state.groups.map(function (json) {
                                    ...
                                    <div className="text-center">
                                        <Button type="submit" color="primary">Matricular</Button>
                                    </div>
                                </form>
