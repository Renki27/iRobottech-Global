...
class DisableCourse extends Component {
  constructor(props) {
    super(props);
    this.state = {
      emailD: "",
      ...
      <div className="container">
        <Row>
          <Col className="mx-auto">
            <Card>
              <CardBody>
                <p className="h5 text-center mb-4">Deshabilitar Curso</p>
                ...
                <div className="col">
                  ...
                  <small id="emailHelp" className="form-text text-muted">
                    Dijite el nombre del curso que desea deshablitar.
                  </small>
                </div>
                  ...
                  >
                    ...
                    <DialogContent>
                      <DialogContentText id="alert-dialog-description">
                        Está seguro que desea deshabilitar el curso: "{this.state.person_data} " ?
                      </DialogContentText>
                    </DialogContent>
                    <DialogActions>
